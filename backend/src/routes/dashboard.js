...
// GET /api/dashboard/stats — cross-project overview
...
// GET /api/dashboard/velocity — sprint velocity per product
...
// GET /api/dashboard/workload — items per developer
...
// GET /api/dashboard/delayed — delayed items across all projects
